...
橙色表示重点题目，优先复习；黑色表示常规错题/重点题，需要复习；灰色表示不重要的题目，有些细节需要注意，可以不复习；删除线表示已掌握的题目，不需要复习。
...
|                                                       |                                      |                                            |                   |          |          |                |
| ==                                                    | ==========                           | ====================                       | 数组              | ===      | ======   | =========      |
| [📕](1.两数之和.md)                                    | 1                                    | 两数之和                                   | 数组              | 简单     | 0        | 2022.1.13      |
| [📕](4.寻找两个正序数组的中位数.md)                    | 4                                    | 寻找两个正序数组的中位数                   | 数组              | 困难     | 0        | 2022.1.13      |
|                                                       |                                      |                                            |                   |          |          |                |
| ==                                                    | ==========                           | ====================                       | 链表              | ===      | ======   | =========      |
| [📕](206.反转链表.md)                                  | <font color='orange'>**206**</font>  | **反转链表**                               | **链表**          | **简单** | **0**    | **2022.1.15**  |
| [📕](25.K个一组翻转链表.md)                            | <font color='orange'>**25**</font>   | **K个一组翻转链表**                        | **链表**          | **困难** | **0**    | **2022.1.15**  |
| [📕](146.LRU缓存.md)                                   | <font color='orange'>**146**</font>  | **LRU缓存**                                | **双向链表**      | **中等** | **0**    | **2022.1.15**  |
|                                                       |                                      |                                            |                   |          |          |                |
| ==                                                    | ==========                           | ====================                       | 二分查找          | ===      | ======   | =========      |
...
| [📕](3.无重复字符的最长字串.md)                        | <font color='orange'>**3**</font>    | **无重复字符的最长字串**                   | **字符串**        | **中等** | **1**    | **2022.1.14**  |
|                                                       |                                      |                                            |                   |          |          |                |
| ==                                                    | ==========                           | ====================                       | 树                | ===      | ======   | =========      |
| [📕](103.二叉树的锯齿形层次遍历.md)                    | 103                                  | 二叉树的锯齿形层次遍历                     | BFS               | 中等     | 0        | 2022.1.18      |
|                                                       |                                      |                                            |                   |          |          |                |
| ==                                                    | ==========                           | ====================                       | 排序              | ===      | ======   | =========      |
| [📕](215.数组中的第K个最大元素.md)                     | **215**                              | **数组中的第K个最大元素**                  | **快排**          | **中等** | **0**    | **2021.12.26** |
| [📕](347.前K个高频元素.md)                             | **347**                              | **前K个高频元素**                          | **堆排**          | **中等** | **0**    | **2021.12.26** |
|                                                       |                                      |                                            |                   |          |          |                |
| ==                                                    | ==========                           | ====================                       | 搜索              | ===      | ======   | =========      |
| [📕](695.岛屿的最大面积.md)                            | 695                                  | 岛屿的最大面积                             | DFS/BFS           | 中等     | 0        | 2021.12.28     |
| [📕](547.省份数量.md)                                  | **547**                              | **省份数量**                               | **DFS/并查集**    | **中等** | **1**    | **2021.12.28** |
|                                                       |                                      |                                            |                   |          |          |                |
|                                                       |                                      |                                            |                   |          |          |                |
| ==                                                    | ==========                           | ====================                       | 数学              | ===      | ======   | =========      |
...
| [📕](1078.Bigram分词)                                  | 1078                                 | Bigram分词                                 | 模拟              | 简单     | 0        | 2021.12.26     |
| [📕](825.适龄的朋友.md)                                | 825                                  | 适龄的朋友                                 | 排序              | 中等     | 1        | 2021.12.27     |
| [📕](472.连接词)                                       | 472                                  | 连接词                                     |                   | 困难     | 1        | 2021.12.28     |
| [📕](1995.统计特殊四元组.md)                           | 1995                                 | 统计特殊四元组                             |                   | 简单     | 0        | 2021.12.29     |
| [📕](846.一手顺子.md)                                  | 846                                  | 一手顺子                                   | 贪心+优先级队列   | 中等     | 0.5      | 2021.12.30     |
| [📕](507.完美数.md)                                    | **507**                              | **完美数**                                 |                   | **简单** | **1**    | **2021.12.31** |
| [📕](2022.将一维数组转变为二维数组.md)                 | 2022                                 | 将一维数组转变为二维数组                   | 模拟              | 简单     | 0        | 2022.1.1       |
| [📕](390.消除游戏.md)                                  | 390                                  | 消除游戏                                   | 数学/模拟         | 中等     | 1        | 2022.1.2       |
| [📕](1185.一周中的第几天.md)                           | 1185                                 | 一周中的第几天                             | 模拟              | 简单     | 0.5      | 2022.1.3       |
| [📕](747.至少是其他数字两倍的最大数.md)                | 747                                  | 至少是其他数字两倍的最大数                 | 模拟              | 简单     | 0        | 2022.1.13      |
| [📕](373.查找和最小的K对数字.md)                       | 373                                  | 查找和最小的K对数字                        | 多路归并          | 中等     | 1        | 2022.1.14      |
| [📕](1716.计算力扣银行的钱)                            | 1716                                 | 计算力扣银行的钱                           | 模拟              | 简单     | 0        | 2022.1.15      |
| [📕](382.链表随机节点.md)                              | 382                                  | 链表随机节点                               | 模拟              | 中等     | 0        | 2022.1.16      |
| [📕](1220.统计元音字母序列的个数.md)                   | 1220                                 | 统计元音字母序列的个数                     | dp                | 困难     | 1        | 2022.1.17      |
| [📕](539.最小时间差.md)                                | 539                                  | 最小时间差                                 | 模拟              | 中等     | 1        | 2022.1.18      |
| [📕](219.存在重复元素II)                               | 219                                  | 存在重复元素II                             | 模拟              | 简单     | 0        | 2022.1.19      |
